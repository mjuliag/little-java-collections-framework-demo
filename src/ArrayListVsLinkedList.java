...
public class ArrayListVsLinkedList {
     ...
     * Linked List - [0] > [1] > [2]
     *                   <     <
     * ArrayList needs to rearrange the hole Array when you remove or add something at the beginning which takes more
     * time and memory
     * LinkedList only rearrange the pointers!
     * We use Array List - When we have to add at the end and remove from the end
     * We use Linked List - When we have add at the beginning and remove from the beginning
     */
